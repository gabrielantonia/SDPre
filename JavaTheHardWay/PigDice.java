...
public class PigDice{
  public static void main(String[]args){
    ...
    do{
      ...
      ptot+=turnTotal;
      System.out.print("\tYou end the round with "+ptot+" points. ");
      ...
      if(ptot>ctot){
        System.out.println("Humanity wins, the future is saved!");
      }
      else{
        System.out.println("The robots control the World!");
      }
